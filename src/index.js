...
var Adapter = function(settings) {
	...
	var initializeConnectionSettings = function () {
        if(!settings.host) { 
            throw new Error('hosting not informed'); 
        }

		if(!settings.user) { 
            throw new Error('username not informed'); 
        }

		if (!settings.port) { 
            throw new Error('port not informed'); 
        }
